...
if __name__ == '__main__':
    ...
    ab_label, ag_label = {}, {}
    ab_info_dict = {}
    if 'ab_seq' in antibody.columns:
        antibody.insert(loc=0, column='H_cdr', value='')
        antibody.insert(loc=1, column='L_cdr', value=None)
        ...
        for index, values in antibody.iterrows():
            ...
            antibody.loc[index, 'H_cdr'] = h_cdr
            ab_cdr+=h_cdr
            if 'L_cdr' in ab_info:
                l_cdr = ab_info['L_cdr']
                ...
                antibody.loc[index, 'L_cdr'] = l_cdr
            # antibody['ab_seq'].iloc[index] = ab_cdr
            antibody.loc[index, 'ab_seq'] = ab_cdr
