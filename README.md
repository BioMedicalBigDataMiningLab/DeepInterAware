...
All the processed dataset can be downloaded from [Link](https://drive.google.com/file/d/12uMgZLxpqhP70tPNp-K4LFksN4E0re30/view?usp=drive_link)  and stored in the data directory.You need to first extract the CDR regions into a CSV file, and then proceed with the subsequent data processing steps.To preprocess all datasets, please run,
...
```sh
python main.py --cfg ./configs/AVIDa_hIL6.yml --dataset AVIDa_hIL6 --gpu 0 --batch_size 512 --unseen_task ag_unseen
```
